...
are created and stored in a such a way that the only way to spend funds is
through physical access. They should only be kept offline, and should be
generated by devices which have never and will never be connected to the
Internet.
